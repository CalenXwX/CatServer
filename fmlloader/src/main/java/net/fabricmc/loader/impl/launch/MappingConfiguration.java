...
public final class MappingConfiguration {
	...
	public String getTargetNamespace() {
		return "srg"; // FabricLauncherBase.getLauncher().isDevelopment() ? "named" : "intermediary"; // CatServer - use forge srg
	}

	public boolean requiresPackageAccessHack() {
		// TODO
		return true; // FIX_PACKAGE_ACCESS || getTargetNamespace().equals("named"); // CatServer - intermediary -> srg
	}
