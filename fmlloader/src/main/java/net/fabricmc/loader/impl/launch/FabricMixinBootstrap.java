...
public final class FabricMixinBootstrap {
	...
	public static void init(EnvType side, FabricLoaderImpl loader) {
		...
		/* // CatServer - forge launches mixin
		...
		*/
		...
		MixinBootstrap.init(); // CatServer - init mixin early for TaggedChoiceMixin TaggedChoiceTypeMixin

		MixinEnvironment.getDefaultEnvironment().setOption(org.spongepowered.asm.mixin.MixinEnvironment.Option.REFMAP_REMAP, true);

		if (/*FabricLauncherBase.getLauncher().isDevelopment()*/true) { // CatServer
