...
public class GameTransformer {
	...
	@Deprecated private Map<String, byte[]> patchedClasses; // CatServer comment - always empty in CatServer
	...
	@Deprecated // CatServer - we removed all patches because we added them into forge code, so this method does nothing
