...
public final class SystemProperties {
	...
	@Deprecated public static final String REMAP_CLASSPATH_FILE = "fabric.remapClasspathFile"; // CatServer - we remap all fabric mods, so this property is no longer used
