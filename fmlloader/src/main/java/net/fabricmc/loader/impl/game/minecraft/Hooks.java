...
public final class Hooks {
	...
	public static final java.util.concurrent.atomic.AtomicBoolean isFabricLoadingRegistries = new java.util.concurrent.atomic.AtomicBoolean(false); // CatServer

	// CatServer comment - called in Main injected by BrandingPatch#applyBrandingPatch
	...
	public static void startServer(File runDir, Object gameInstance) {
		...
		isFabricLoadingRegistries.set(true); // CatServer
		...
		isFabricLoadingRegistries.set(false); // CatServer
	}
