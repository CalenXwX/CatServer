...
public final class LoaderUtil {
	...
	public static void verifyClasspath() {
		try {
			...
			/* // CatServer - skip ASM detect. we call Knot#<init> in FabricLoaderLaunchPluginService#handleClass with an ASM parameter. ASM is not loaded by LoaderUtil.class.getClassLoader() in forge
