...
public final class AccessWidener implements AccessWidenerVisitor {
	...
	public Access getMethodAccess(EntryTriple entryTriple) { // CatServer - public
	...
	public interface Access extends AccessOperator { // CatServer - public
	...
	@FunctionalInterface
	public interface AccessOperator { // CatServer - public
