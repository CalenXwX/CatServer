...
public class FabricItemGroupEntries implements CreativeModeTab.Output {
	...
	/**
	 * See {@link #prepend(ItemStack, TabVisibility)}.
	...
	/**
	 * See {@link #addAfter(ItemLike, Collection, TabVisibility)}}.
	 */
	...
	/**
	 * See {@link #addAfter(ItemStack, Collection, TabVisibility)}}.
	 */
	...
	/**
	 * See {@link #addBefore(ItemLike, Collection, TabVisibility)}}.
	 */
	...
	/**
	 * See {@link #addBefore(ItemStack, Collection, TabVisibility)}}.
	 */
