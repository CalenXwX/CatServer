...
public final class FabricBrewingRecipeRegistry {
	...
	public static void registerItemRecipe(PotionItem input, Ingredient ingredient, PotionItem output) {
		...
		PotionBrewing.CONTAINER_MIXES.add(new PotionBrewing.Mix<>(net.minecraftforge.registries.ForgeRegistries.ITEMS, input, ingredient, output));
	}
	...
	public static void registerPotionRecipe(Potion input, Ingredient ingredient, Potion output) {
		...
		PotionBrewing.POTION_MIXES.add(new PotionBrewing.Mix<>(net.minecraftforge.registries.ForgeRegistries.POTIONS, input, ingredient, output));
	}
}
