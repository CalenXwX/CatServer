...
public interface LootTableLoadingCallback {
	...
	void onLootTableLoading(ResourceManager resourceManager, LootDataManager manager, ResourceLocation id, FabricLootSupplierBuilder supplier, LootTableSetter setter);
}
