...
public final class LootTableEvents {
	...
	public interface Replace {
		 ...
		 */
		@Nullable
		LootTable replaceLootTable(ResourceManager resourceManager, LootDataManager lootManager, ResourceLocation id, LootTable original, LootTableSource source);
	}
	...
	public interface Modify {
		 ...
		 */
		void modifyLootTable(ResourceManager resourceManager, LootDataManager lootManager, ResourceLocation id, LootTable.Builder tableBuilder, LootTableSource source);
	}
	...
	public interface Loaded {
		 ...
		 * @param lootManager     the loot manager
		 */
		void onLootTablesLoaded(ResourceManager resourceManager, LootDataManager lootManager);
	}
}
