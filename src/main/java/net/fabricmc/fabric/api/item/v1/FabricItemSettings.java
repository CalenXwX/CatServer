...
public class FabricItemSettings extends Item.Properties {
	...
	@Override
	public FabricItemSettings stacksTo(int maxCount) {
		super.stacksTo(maxCount);
		return this;
	}

	@Override
	public FabricItemSettings defaultDurability(int maxDamage) {
		super.defaultDurability(maxDamage);
		return this;
	}

	@Override
	public FabricItemSettings durability(int maxDamage) {
		super.durability(maxDamage);
		return this;
	}

	@Override
	public FabricItemSettings craftRemainder(Item recipeRemainder) {
	...
	@Override
	public FabricItemSettings requiredFeatures(FeatureFlag... features) {
