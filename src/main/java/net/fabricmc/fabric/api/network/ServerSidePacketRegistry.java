...
public interface ServerSidePacketRegistry extends PacketRegistry {
	 ...
	 */
	boolean canPlayerReceive(Player player, ResourceLocation id);
	 ...
	 */
	void sendToPlayer(Player player, Packet<?> packet, GenericFutureListener<? extends Future<? super Void>> completionListener);
	 ...
	 *                           the success or failure of sending a given packet, among others.
	 */
	default void sendToPlayer(Player player, ResourceLocation id, FriendlyByteBuf buf, GenericFutureListener<? extends Future<? super Void>> completionListener) {
	 ...
	 * @param packet The packet to be sent.
	 */
	default void sendToPlayer(Player player, Packet<?> packet) {
	 ...
	 * @param buf    The packet byte buffer.
	 */
	default void sendToPlayer(Player player, ResourceLocation id, FriendlyByteBuf buf) {
