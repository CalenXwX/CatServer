...
public interface FabricLootTableProvider extends LootTableSubProvider, DataProvider {
	 ...
	 */
	default BiConsumer<ResourceLocation, LootTable.Builder> withConditions(BiConsumer<ResourceLocation, LootTable.Builder> exporter, ConditionJsonProvider... conditions) {
