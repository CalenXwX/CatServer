...
public abstract class SimpleFabricLootTableProvider implements FabricLootTableProvider {
	...
	public SimpleFabricLootTableProvider(FabricDataOutput output, LootContextParamSet lootContextType) {
		this.output = output;
	...
	public String getName() {
		return Objects.requireNonNull(LootContextParamSets.getKey(lootContextType), "Could not get id for loot context type") + " Loot Table";
	}
}
