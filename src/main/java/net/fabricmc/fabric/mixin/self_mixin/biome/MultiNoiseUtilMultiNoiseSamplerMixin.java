...
package net.fabricmc.fabric.mixin.self_mixin.biome; // package net.fabricmc.fabric.mixin.biome; // CatServer - we can't modify a record field, even if we use MethodHandle or VarHandle, so maybe remaining the mixin is a better way
