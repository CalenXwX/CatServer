...
public final class FuelRegistryImpl implements FuelRegistry {
	...
	@Deprecated private volatile Map<Item, Integer> fuelTimeCache = null; // thread safe via copy-on-write mechanism // CatServer - @Deprecated don't use fabric cache. use forge logic
	...
	@Deprecated // CatServer - don't use fabric cache. use forge logic
	...
	public Integer get(ItemLike item) {
		return net.minecraftforge.common.ForgeHooks.getBurnTime(new net.minecraft.world.item.ItemStack(item.asItem()), null); // CatServer - don't use fabric cache. use forge logic
	}
