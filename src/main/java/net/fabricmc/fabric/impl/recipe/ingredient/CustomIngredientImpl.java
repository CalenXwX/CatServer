...
public class CustomIngredientImpl extends Ingredient {
	...
	public static final int PACKET_MARKER = -2; //-1; // CatServer - Forge uses -1, so let Fabric use another value
	...
	public boolean isEmpty() {
		...
		return getItems() != null && getItems().length == 0; // CatServer - matchingStacks -> getItems()
	}
