...
public final class DynamicRegistriesImpl {
	private static final List<RegistryDataLoader.RegistryData<?>> DYNAMIC_REGISTRIES = net.minecraftforge.registries.DataPackRegistriesHooks.DATA_PACK_REGISTRIES; // new ArrayList<>(RegistryDataLoader.WORLDGEN_REGISTRIES); // CatServer - we use forge's
