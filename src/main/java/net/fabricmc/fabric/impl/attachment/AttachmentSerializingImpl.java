...
public class AttachmentSerializingImpl {
	...
	public static void serializeAttachmentData(CompoundTag nbt, @Nullable IdentityHashMap<AttachmentType<?>, ?> attachments) {
	...
	@Nullable
	public static IdentityHashMap<AttachmentType<?>, Object> deserializeAttachmentData(CompoundTag nbt) {
