...
public class BiomeModificationContextImpl implements BiomeModificationContext {
	...
	private class WeatherContextImpl implements WeatherContext {
		...
		public void setPrecipitation(boolean hasPrecipitation) {
			Holder<Biome> biomeHolder = net.minecraftforge.registries.ForgeRegistries.BIOMES.getHolder(biome).get();
			net.minecraftforge.common.world.ModifiableBiomeInfo.BiomeInfo.Builder builder = net.minecraftforge.common.world.ModifiableBiomeInfo.BiomeInfo.Builder.copyOf(biome.modifiableBiomeInfo().get());
			builder.getClimateSettings().setHasPrecipitation(hasPrecipitation);
			biome.modifiableBiomeInfo().catserver$replaceBiomeInfo(biomeHolder, builder);
		}
