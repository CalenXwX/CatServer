...
public final class LootTablesV1Init implements ModInitializer {
	private static final ThreadLocal<Map<ResourceLocation, BufferingLootTableBuilder>> BUFFERS = ThreadLocal.withInitial(HashMap::new);
	...
	public void onInitialize() {
		...
		LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
			Map<ResourceLocation, BufferingLootTableBuilder> buffers = BUFFERS.get();
