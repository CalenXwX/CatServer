...
public class CraftVillagerZombie extends CraftZombie implements ZombieVillager {
    ...
    public Villager.Profession getVillagerProfession() {
        return Villager.Profession.valueOf(catserver.server.BukkitInjector.standardize(BuiltInRegistries.VILLAGER_PROFESSION.getKey(getHandle().getVillagerData().getProfession()))); // CatServer
    }
